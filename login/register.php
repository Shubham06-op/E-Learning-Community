...
if(isset($_POST['name']) && isset($_POST['email']) && isset($_POST['pass']) && isset($_POST['submit2']))
{
    ...
    $create="CREATE TABLE IF NOT EXISTS register(id SERIAL PRIMARY KEY, name varchar(50), email varchar(50) UNIQUE NOT NULL, password varchar(50))";
    $insert="INSERT INTO register(name,email,password) VALUES ('".$_POST['name']."','".$_POST['email']."','".md5($_POST['pass'])."')";
