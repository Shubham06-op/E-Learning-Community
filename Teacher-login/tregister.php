...
if(isset($_POST['tname']) && isset($_POST['temail']) && isset($_POST['tpass']) && isset($_POST['tsubmit2']) && isset($_POST['text1']))
{
    ...
    $create="CREATE TABLE IF NOT EXISTS mentor_register(tid SERIAL PRIMARY KEY, name varchar(50), email varchar(50) UNIQUE NOT NULL, password varchar(50), field varchar(100))";
    $insert="INSERT INTO mentor_register(name,email,password,field) VALUES ('".$_POST['tname']."','".$_POST['temail']."','".md5($_POST['tpass'])."','".$_POST['text1']."')";
